...
```{r}
work_dir<- normalizePath(paste0(getwd(), "/../")) #adjust working directory accordingly. This is the R project folder
source(here::here("scripts", "1_importing_fcs_metadata_source.R"))
```
...
```{r}
metadata_processing(paste0(work_dir,"Metadata/PE_Cruises_VP_Metadata.xlsx"), extension = ".xlsx", project_title = "PE_Cruises_test")
...
```{r}
origin<- paste0(work_dir,"./Data/") # Use absolute path

import_fcs(origin, project_title)
```


**5. Creating Ref file**\ #NOT NEEDED ANYMORE
